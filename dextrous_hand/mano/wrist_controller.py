...
class WristController:
    ...
    def get_wrist_command(self, wrist_pos: list[float], wrist_quat: list[float], elbow_quat: list[float]) -> tuple[float, float]:
        """
        ...
        wrist_with_elbow_joint = Rotation.from_quat(wrist_quat).as_euler('xyz', degrees=False)[0]
        return wrist_joint, wrist_with_elbow_joint
